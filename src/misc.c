...
get_err_msg(enum err_status error)
{
	...
	/* INV_REQ_TYPE       */ "invalid or missing Request Type",
	/* INV_GET            */ "invalid GET",
	...
	/* NO_FREE_SPOT       */ "the posted filename already exists",
	...
	/* INV_POST_PATH      */ "invalid POST path specified",
	/* INV_CONNECTION     */ "invalid connection type",
	/* INV_HOST           */ "invalid host",
